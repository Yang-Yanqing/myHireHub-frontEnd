...
const JobCard=({job, onClick,showApply=false}: Props)=>{
    ...
    return(
        <div className="job-card" onClick={onClick} role={onClick?"button":undefined}>
            ...
            {showApply&&(<div className="job-card__actions" onClick={(e) => e.stopPropagation()}>
                {url?(<a className="job-card__link" href={url} target="_blank" rel="noreferrer">Check/Apply</a>):(
